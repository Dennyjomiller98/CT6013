    ...
    <body>
        ...
        <div class="mainBody">
            ...
            <%}else {
                ...
                {%>
                    <p>
                        Teachers do not have access to this page. <a class="bodyA" href=${pageContext.request.contextPath}/servlets/redirects/HomeToTeacherIndex>&nbsp;Return to Teacher Portal&nbsp;</a>
                    </p>
                <%} else {%>
                    <p>
