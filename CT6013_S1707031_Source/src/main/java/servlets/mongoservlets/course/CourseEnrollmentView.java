...
@WebServlet(name = "mongoCourseEnrollmentView")
public class CourseEnrollmentView extends HttpServlet
{
	static final Logger LOG = Logger.getLogger(CourseEnrollmentView.class);
